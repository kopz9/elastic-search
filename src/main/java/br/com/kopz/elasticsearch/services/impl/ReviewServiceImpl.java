...
import br.com.kopz.elasticsearch.exceptions.ReviewNotAllowedException;
import br.com.kopz.elasticsearch.repositories.RestaurantRepository;
import br.com.kopz.elasticsearch.services.ReviewService;
...
public class ReviewServiceImpl implements ReviewService {
  ...
  public Optional<Review> getReview(String restaurantId, String reviewId) {
    var restaurant = getRestaurantOrThrow(restaurantId);
