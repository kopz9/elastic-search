...
import br.com.kopz.elasticsearch.services.StorageService;
...
public class FileSystemStorageService implements StorageService {
  ...
  public String store(MultipartFile file, String fileName) {
    try {
      ...
      Path destionationFile = rootLocation.resolve(Paths.get(finalFileName)).normalize().toAbsolutePath();

      if (!destionationFile.getParent().equals(rootLocation.toAbsolutePath())) {
